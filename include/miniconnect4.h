...
#define MC4_OPTIONS_LANGUAGE 7
#define MC4_LANG_EN 0
#define MC4_LANG_DE 1
#define MC4_LANG_PL 2
#define MC4_LANG_ENGLISH 0
#define MC4_LANG_GERMAN 1
#define MC4_LANG_POLISH 2
...
enum MC4TextId {
    MC4_TX_NEW_GAME, MC4_TX_QUIT, MC4_TX_LOBBY, MC4_TX_DISCONNECT,
    MC4_TX_PLAYER_NAME, MC4_TX_TOGGLE_CHAT, MC4_TX_COLORS, MC4_TX_HUMAN,
    MC4_TX_AI_EASY, MC4_TX_AI_MEDIUM, MC4_TX_AI_HARD, MC4_TX_LANGUAGE,
    MC4_TX_ENGLISH, MC4_TX_GERMAN, MC4_TX_POLISH, MC4_TX_OPTIONS,
    MC4_TX_NETWORK, MC4_TX_PROJECT, MC4_TX_INFO, MC4_TX_YOUR_TURN,
    MC4_TX_REMOTE_TURN, MC4_TX_COMPUTER_TURN, MC4_TX_PLAYER1_TURN,
    MC4_TX_PLAYER2_TURN, MC4_TX_COMPUTER_THINKS, MC4_TX_WAIT_REMOTE,
    MC4_TX_COLUMN_FULL, MC4_TX_YOU_WON, MC4_TX_YOU_LOST, MC4_TX_PLAYER,
    MC4_TX_WINS, MC4_TX_DRAW, MC4_TX_LOBBY_FALLBACK, MC4_TX_OFFLINE_LOCAL,
    MC4_TX_HUMAN_MODE, MC4_TX_COMPUTER_EASY_STATUS, MC4_TX_COMPUTER_MEDIUM_STATUS,
    MC4_TX_COMPUTER_HARD_STATUS, MC4_TX_NO_ANSWER, MC4_TX_INVITE_SENT,
    MC4_TX_INVITE_FAILED, MC4_TX_CONNECTED, MC4_TX_NAME_IN_USE, MC4_TX_INVITE_FROM,
    MC4_TX_ACCEPTED, MC4_TX_DECLINED, MC4_TX_ACCEPT_INVITE, MC4_TX_DECLINED_SUFFIX,
    MC4_TX_GAME_STARTED_YOUR, MC4_TX_GAME_STARTED_REMOTE, MC4_TX_REMOTE_PLAYER,
    MC4_TX_NEW_NETWORK_GAME, MC4_TX_REMOTE_DISCONNECTED, MC4_TX_LOBBY_PLAYERS,
    MC4_TX_NO_PLAYERS, MC4_TX_IN_GAME, MC4_TX_REQUEST_GAME, MC4_TX_COLOR_BG,
